  ...
  return (
    <main className="direction-page quiet-page" id="top">
      ...
      <section className="quiet-evidence reveal-on-scroll" id="evidence">
        ...
        <div className="evidence-panel reveal-on-scroll stagger-2"><div className="evidence-panel-head"><span>Sky Protocol / MIP-128 / 0x3aC8...9f21</span><span className="evidence-status"><span className="status-dot live" /> Registry proof written</span></div><div className="evidence-metrics"><div><b><AnimatedMetric value={24} /></b><span>executions this month</span></div><div><b><AnimatedMetric value={4.2} suffix="m" decimals={1} /></b><span>average delay</span></div><div><b><AnimatedMetric value={98.7} suffix="%" decimals={1} /></b><span>reliability / 30d</span></div></div><div className="evidence-record"><div className="evidence-record-row"><span className="evidence-icon"><Check size={13} /></span><div><b>Governance passed</b><small>Debt ceiling adjustment · block 21,046,704</small></div><time>09:38:14</time></div><div className="evidence-record-row"><span className="evidence-icon"><Check size={13} /></span><div><b>Simulation scored GREEN</b><small>8.4 gwei gas · $1.21B Vat headroom · 0 conflicts</small></div><time>09:38:22</time></div><div className="evidence-record-row"><span className="evidence-icon"><Check size={13} /></span><div><b>KeeperHub confirmed</b><small>1,248,921 gas used · block 21,046,744</small></div><time>09:39:01</time></div><div className="evidence-record-row"><span className="evidence-icon"><Check size={13} /></span><div><b>Registry proof written</b><small>Base AxonRegistry #184 · 0x813...8b19</small></div><time>09:39:05</time></div></div><div className="evidence-panel-foot"><span><ShieldCheck size={14} /> 47 seconds total · $2.84B value secured</span><a href="/execution/0x3aC8...9f21">View full execution <ArrowRight size={14} /></a></div></div>
      </section>
      ...
      <section className="quiet-maintainers" id="maintainers">
        ...
        <div className="maintainer-action"><p>Register the contracts and operation types Axon should watch. We review the execution surface with you before anything runs.</p><button className="button button-light" onClick={() => window.alert("Registration flow coming next.")}>Register a protocol <ArrowUpRight size={17} /></button></div>
      </section>
      <QuietFooter />
    </main>
  );
